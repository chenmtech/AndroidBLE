...
public class DeviceRegisterInfo implements Serializable {
    ...
    private static final String DEFAULT_DEVICE_NAME = ""; // 缺省设备名
    ...
    private static final boolean DEFAULT_LOCAL = true; // 缺省的是否本地设备
    ...
    private boolean warnWhenBleInnerError = DEFAULT_WARN_WHEN_BLE_INNER_ERROR; // 蓝牙内部错误是否报警

    public DeviceRegisterInfo(boolean isLocal, String macAddress, String uuidStr) {
        this.isLocal = isLocal;
        this.macAddress = macAddress;
        this.uuidStr = uuidStr;
    }

    private DeviceRegisterInfo(boolean isLocal, String macAddress, String name, String uuidStr, String imagePath,
    ...
    private static DeviceRegisterInfo readFromPref(SharedPreferences pref, String macAddress) {
        ...
        return new DeviceRegisterInfo(true, address, nickName, uuidString, imagePath, autoConnect, warnWhenBleError);
    }
